...
const projectsData = [
  ...
  // issuer doubles as the filter group label, so keep it short and consistent across entries from the same platform
  const certsData = [
    { name: "Introduction to Responsible AI", issuer: "Google Cloud Skills Boost", date: "Aug 2026", id: "26266138", skills: "Artificial Intelligence (AI), Logical Thinking, Responsible AI" },
    { name: "Introduction to Generative AI", issuer: "Google Cloud Skills Boost", date: "Aug 2026", id: "26244974", skills: "Artificial Intelligence (AI), Problem Solving & Logical Thinking, Generative AI Concepts" },
    { name: "Introduction to Data Science", issuer: "Cisco Networking Academy", date: "Aug 2026", id: "5a3826db-a220-4470-8426-9a17cd105f3d", skills: "Data Science, Problem Solving, Data Analysis, Statistical Thinking" },
    { name: "Artificial Intelligence Fundamentals", issuer: "IBM", date: "Aug 2026", id: "f7aa2d86-98b8-45c0-ba27-958fbec48053", skills: "Data Science, Artificial Intelligence (AI), Machine Learning Basics, AI Ethics" },
  ...
  // Both filter bars work the same way: read the categories already sitting on the
  // cards, build a pill per unique value, and toggle visibility on click.
